...
export const navigationData: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { id: "rr-setup", label: "Setup & BrowserRouter" },
      { id: "rr-routes", label: "Routes & Route Params" },
  ...
  },
  {
    ...
    items: [
      { id: "rtk-setup", label: "Setup Store & Slice" },
      { id: "rtk-slice", label: "createSlice & Reducers" },
      { id: "rtk-thunk", label: "Async Thunk" },
      { id: "rtk-selector", label: "useSelector & useDispatch" },
    ],
  },
  {
